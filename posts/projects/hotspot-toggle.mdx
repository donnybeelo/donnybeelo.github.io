...
image: "/projects/hotspot-toggle.webp"
---
...
- <u>Quick Settings Integration</u>: Toggle your phone's hotspot directly from the GNOME Shell Quick Settings menu
- <u>Automatic Wi-Fi Connection</u>: Automatically connects to your phone's hotspot network as fast as possible
- <u>Visual Indicator</u>: Status indicator shows when connected to the hotspot network
- <u>Bluetooth-Based Control</u>: Uses Bluetooth connectivity to communicate with your Android device, unlike GSConnect
- <u>Settings UI</u>: Easy to configure, so you can get going with no programming knowledge necessary
